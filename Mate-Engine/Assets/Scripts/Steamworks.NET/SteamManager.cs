...
public class SteamManager : MonoBehaviour {
	...
	protected virtual void Awake() {
		...
		if (!m_bInitialized) {
#if UNITY_EDITOR
			Debug.Log("[Steamworks.NET] SteamAPI_Init() returned false or Steam client not running in Unity Editor. Proceeding in standalone/offline mode without breaking pipeline connection.");
#else
