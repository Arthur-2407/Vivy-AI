...
#pragma warning restore 0414
    ...
    void Update()
    {
        enableBigScreenAlarm = (SaveLoadHandler.Instance != null && SaveLoadHandler.Instance.data != null) ? SaveLoadHandler.Instance.data.alarmsEnabled : false;
        ...
        bool isBigScreen = avatarAnimator != null && avatarAnimator.IsValidAndPlaying() && avatarAnimator.GetBool("isBigScreen");
        bool isBigScreenAlarm = avatarAnimator != null && avatarAnimator.IsValidAndPlaying() && avatarAnimator.GetBool("isBigScreenAlarm");
    ...
    {
        if (avatarAnimator == null || !avatarAnimator.IsValidAndPlaying() || allowedStates == null || allowedStates.Length == 0)
            return true;
