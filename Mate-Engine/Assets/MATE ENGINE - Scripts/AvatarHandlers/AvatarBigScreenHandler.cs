...
public class AvatarBigScreenHandler : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isBigScreenActive && MainCamera != null && bone != null && avatarAnimator != null && avatarAnimator.IsValidAndPlaying() && !isFading && !isInDesktopTransition)
    ...
    void ActivateBigScreen()
    {
        ...
        if (avatarAnimator != null && avatarAnimator.IsValidAndPlaying()) avatarAnimator.SetBool("isBigScreen", true);
        ...
        bone = (avatarAnimator != null && avatarAnimator.IsValidAndPlaying()) ? avatarAnimator.GetBoneTransform(attachBone) : null;
    ...
    {
        isFading = true;
        if (avatarAnimator == null || !avatarAnimator.IsValidAndPlaying() || bone == null || MainCamera == null)
        ...
        if (!fadeIn)
        {
            ...
            if (avatarAnimator != null && avatarAnimator.IsValidAndPlaying()) avatarAnimator.SetBool("isBigScreen", false);
