...
public class HandHolder : MonoBehaviour
{
    ...
    float ComputeWorldWeight(Transform hand)
    {
        ...
        if (avatarAnimator != null && avatarAnimator.IsValidAndPlaying() && avatarAnimator.GetBool("isBigScreen"))
    ...
    bool IsValid() => avatarAnimator && avatarAnimator.IsValidAndPlaying() && leftHand && rightHand && chest && leftShoulder && rightShoulder;
}