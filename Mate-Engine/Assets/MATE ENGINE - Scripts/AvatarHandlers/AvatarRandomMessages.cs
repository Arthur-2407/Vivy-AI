...
#pragma warning restore 0414
    ...
    void Update()
    {
        ...
        if (avatarAnimator != null && avatarAnimator.IsValidAndPlaying())
        {
    ...
    void ShowSpecificMessage(AvatarMessage msg)
    {
        ...
        if (avatarAnimator != null && avatarAnimator.IsValidAndPlaying()) avatarAnimator.SetBool("isTalking", true);
    ...
    IEnumerator FakeStreamText(string fullText)
    {
        ...
        if (avatarAnimator != null && avatarAnimator.IsValidAndPlaying()) avatarAnimator.SetBool("isTalking", false);
    ...
    {
        if (avatarAnimator == null || !avatarAnimator.IsValidAndPlaying() || allowedStates == null || allowedStates.Length == 0) return true;
        var current = avatarAnimator.GetCurrentAnimatorStateInfo(0);
    ...
    {
        if (avatarAnimator == null || !avatarAnimator.IsValidAndPlaying()) return true;
    ...
    {
        if (avatarAnimator == null || !avatarAnimator.IsValidAndPlaying()) return false;
    ...
    {
        if (avatarAnimator == null || !avatarAnimator.IsValidAndPlaying()) return "";
