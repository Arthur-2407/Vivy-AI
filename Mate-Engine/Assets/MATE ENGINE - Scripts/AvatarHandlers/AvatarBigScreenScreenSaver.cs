...
public class AvatarBigScreenScreenSaver : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool isBigScreenSaver = avatarAnimator != null && avatarAnimator.IsValidAndPlaying() && avatarAnimator.GetBool("isBigScreenSaver");
...
public class AvatarBigScreenScreenSaverEditor : UnityEditor.Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            if (script.TryGetComponent<Animator>(out var anim) && anim.IsValidAndPlaying())
            {
